    ...
    setTrustedHtml(this.ctx.container, trustedHtml(`
      ...
      <div class="header">
        ...
        return `
          ...
          <span class="logo">RAVI MONITOR</span><span class="logo-mobile">RAVI MONITOR</span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}
          <a href="${BRAND_CONFIG.repoUrl}" target="_blank" rel="noopener" class="github-link" title="${t('header.viewOnGitHub')}">
      ...
      <nav class="mobile-menu" id="mobileMenu">
        <div class="mobile-menu-header">
          <span class="mobile-menu-title">RAVI MONITOR</span>
      ...
      <footer class="site-footer">
        <div class="site-footer-brand">
          ...
          <div class="site-footer-brand-text">
            <span class="site-footer-name">RAVI MONITOR</span>
            <span class="site-footer-sub">v${__APP_VERSION__} &middot; <span class="site-footer-credit">Derived from World Monitor by Elie Habib</span></span>
          </div>
        </div>
        <nav>
          <a href="${this.ctx.isDesktopApp ? 'https://worldmonitor.app/pro' : 'https://www.worldmonitor.app/pro'}" target="_blank" rel="noopener">Pro</a>
        ...
        <span class="site-footer-copy">&copy; ${new Date().getFullYear()} Ravi Monitor &middot; Upstream &copy; 2024-2026 Elie Habib (AGPL-3.0)</span>
      </footer>
