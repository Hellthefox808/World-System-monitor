...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  full: {
    title: `${BRAND_CONFIG.name} - Real-Time Global Intelligence Dashboard`,
    description: `${BRAND_CONFIG.name} — real-time global intelligence platform. Conflicts, markets, military, OSINT, and infrastructure monitoring in a unified situational awareness interface.`,
  ...
  tech: {
    title: `RAVI Tech Monitor - Real-Time AI & Tech Industry Dashboard`,
  ...
  happy: {
    title: `RAVI Happy Monitor - Good News & Global Progress`,
  ...
  finance: {
    title: `RAVI Finance Monitor - Real-Time Markets & Trading Dashboard`,
  ...
  commodity: {
    title: `RAVI Commodity Monitor - Real-Time Commodity Markets & Supply Chain Dashboard`,
    ...
    siteName: 'RAVI Commodity Monitor',
  ...
  energy: {
    title: `RAVI Energy Atlas - Real-Time Global Energy Intelligence Dashboard`,
